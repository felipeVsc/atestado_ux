...
function Tela1() {
  ...
  const fetchInitialValues = () => {
    if (userData.paciente_id) {
      axios
        .get(`http://143.198.163.134:5000/paciente/${userData.paciente_id}`)
        .then((response) => {
        ...
        <AppDiv selectedSection={0} tituloDoBloco="Declaração de Óbito">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const bloco1ApiURL = "http://143.198.163.134:5000/paciente/tipo";
              ...
              axios
                ...
                const bloco6ApiURL = "http://143.198.163.134:5000/bloco6";
